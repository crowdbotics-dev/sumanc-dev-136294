"""
Django settings for sumanc_dev_136294 project.
...
ROOT_URLCONF = 'sumanc_dev_136294.urls'
...
WSGI_APPLICATION = 'sumanc_dev_136294.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "sumanC Support <support@sumanc-dev-136294.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sumanc_dev_136294 API",
    "DESCRIPTION": "API documentation for sumanc_dev_136294 App",
    "VERSION": "v1",
}
